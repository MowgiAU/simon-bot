        ...
        <div style={{
                                ...
                                <div style={{ position: 'absolute', top: '100%', right: 0, marginTop: '4px', backgroundColor: '#1A1E2E', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '6px', minWidth: '160px', zIndex: 1000, boxShadow: '0 10px 25px rgba(0,0,0,0.4)', display: 'flex', flexDirection: 'column', gap: '2px' }}
                                    ...
                                    {[user.profileUsername || user.username].map(uname => (
                                        <React.Fragment key="menu">
                                            ...
                                            <Link to="/projects" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 12px', borderRadius: '6px', color: '#B9C3CE', fontSize: '11px', fontWeight: '600', textDecoration: 'none' }} onMouseEnter={e => { e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.color = 'white'; }} onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#B9C3CE'; }}><FolderOpen size={13} /> Projects</Link>
            ...
            <div style={{ flex: 1, display: 'flex', overflow: 'hidden', position: 'relative' }}>
                ...
                <main
                    ...
                    {children}
                    <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '20px 24px', display: isMobile ? 'none' : 'flex', alignItems: 'center', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
