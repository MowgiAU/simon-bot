...
import { ChannelScraperPage } from './ChannelScraper';
import { Shield, Clock, Zap, FileText, ShieldOff, ShieldCheck, Database } from 'lucide-react';
...
const TABS = [
    ...
    { key: 'channel-scraper', label: 'Channel Scraper', icon: Database },
] as const;
...
export function AutomationPage() {
    ...
    return (
        <div>
            ...
            {tab === 'channel-scraper' && <ChannelScraperPage />}
        </div>
    );
}
