        ...
        <div style={{ padding: '24px', height: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', background: colors.surface, padding: '4px', borderRadius: '8px', border: `1px solid ${colors.border}` }}>
                    ...
                    >
                        <AnimatedWrapper icon={List} size={16} /> Tickets
                    </button>
                    <button 
                    ...
                    >
                        <AnimatedWrapper icon={Settings} size={16} /> Settings
                    </button>
                </div>
            </div>
            ...
            {view === 'tickets' ? (
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        borderRight: isMobile ? 'none' : '1px solid #3E455633', 
                        overflowY: 'auto', 
                        display: isMobile && selectedTicket ? 'none' : 'flex', 
                        flexDirection: 'column' 
                    }}>
                            <div style={{ padding: '16px', borderBottom: '1px solid #3E455633', display: 'flex', gap: '8px' }}>
                                <button 
                            ...
                            {filteredTickets.map(ticket => (
                                <div 
                                    ...
                                    style={{ 
                                        padding: '16px 24px', borderBottom: '1px solid #3E455633', cursor: 'pointer',
                        ...
                        {selectedTicket ? (
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'transparent' }}>
                                ...
                                <div style={{ flex: 1, padding: '24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    {loadingMessages ? (
                                        <div style={{ textAlign: 'center', padding: '40px', color: colors.primary }}><RefreshCw className="animate-spin" /></div>
                                    ) : (
                                        messages
                                            .filter(msg => {
                                ...
                                {/* Reply Box */}
                                {selectedTicket.status === 'open' && (
                                    <div style={{ padding: '24px', background: 'rgba(0, 0, 0, 0.2)', borderTop: '1px solid #3E455633', display: 'flex', gap: '12px' }}>
                                        <textarea 
                                            value={replyContent}
