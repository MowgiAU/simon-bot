...
export const LoginPage: React.FC = () => {
    ...
    const [error, setError] = useState(
        ...
        urlError === 'discord_no_account' ? 'No Fuji Studio account is linked to that Discord. Please sign up with email first, then link your Discord from Account Settings.' :
        ''
    );
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                {/* Divider + Discord — login tab only */}
                {tab === 'login' && <div style={{ display: 'flex', alignItems: 'center', gap: spacing.md, margin: `${spacing.xl} 0` }}>
